...
import { DribbbleIcon, GithubIcon, LinkedinIcon, MoonIcon, SunIcon, TwitterIcon,WhatsappIcon } from "../Icons";
...
const toggle = () =>{
  ...
  return (
    <header className="w-full p-4  px-5 sm:px-10 flex items-center justify-between">
        ...
        >
            <Link href="/" className="mr-2">Anasayfa</Link>
            <Link href="/hakkimizda" className="mx-2">Hakkımızda</Link>
            <Link href="/iletisim" className="mx-2">İletişim</Link>
